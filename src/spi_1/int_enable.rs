...
impl W {
    ...
    #[inline(always)]
    pub fn rx_overflow(&mut self) -> RxOverflowW<'_, IntEnableSpec> {
    ...
    #[inline(always)]
    pub fn mode_fail(&mut self) -> ModeFailW<'_, IntEnableSpec> {
    ...
    #[inline(always)]
    pub fn tx_fifo_not_full(&mut self) -> TxFifoNotFullW<'_, IntEnableSpec> {
    ...
    #[inline(always)]
    pub fn tx_fifo_full(&mut self) -> TxFifoFullW<'_, IntEnableSpec> {
    ...
    #[inline(always)]
    pub fn rx_fifo_not_empty(&mut self) -> RxFifoNotEmptyW<'_, IntEnableSpec> {
    ...
    #[inline(always)]
    pub fn px_fifo_full(&mut self) -> PxFifoFullW<'_, IntEnableSpec> {
    ...
    #[inline(always)]
    pub fn tx_fifo_underflow(&mut self) -> TxFifoUnderflowW<'_, IntEnableSpec> {
