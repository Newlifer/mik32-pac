...
impl W {
    #[doc = "Bit 0 - Ядро"]
    #[inline(always)]
    pub fn core(&mut self) -> CoreW<'_, ClkAhbSetSpec> {
        CoreW::new(self, 0)
    }
    #[doc = "Bit 1 - EEPROM"]
    #[inline(always)]
    pub fn eeprom(&mut self) -> EepromW<'_, ClkAhbSetSpec> {
        EepromW::new(self, 1)
    }
    #[doc = "Bit 2 - RAM"]
    #[inline(always)]
    pub fn ram(&mut self) -> RamW<'_, ClkAhbSetSpec> {
        RamW::new(self, 2)
    }
    #[doc = "Bit 3 - SPIFI"]
    #[inline(always)]
    pub fn spifi(&mut self) -> SpifiW<'_, ClkAhbSetSpec> {
        SpifiW::new(self, 3)
    }
    #[doc = "Bit 4 - TCB"]
    #[inline(always)]
    pub fn tcb(&mut self) -> TcbW<'_, ClkAhbSetSpec> {
        TcbW::new(self, 4)
    }
    #[doc = "Bit 5 - DMA"]
    #[inline(always)]
    pub fn dma(&mut self) -> DmaW<'_, ClkAhbSetSpec> {
        DmaW::new(self, 5)
    }
    #[doc = "Bit 6 - Crypto"]
    #[inline(always)]
    pub fn crypto(&mut self) -> CryptoW<'_, ClkAhbSetSpec> {
        CryptoW::new(self, 6)
    }
    #[doc = "Bit 7 - CRC32"]
    #[inline(always)]
    pub fn crc32(&mut self) -> Crc32W<'_, ClkAhbSetSpec> {
        Crc32W::new(self, 7)
    }
}
