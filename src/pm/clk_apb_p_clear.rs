...
impl W {
    #[doc = "Bit 0 - Сторожевой таймер"]
    #[inline(always)]
    pub fn wdt(&mut self) -> WdtW<'_, ClkApbPClearSpec> {
        WdtW::new(self, 0)
    }
    #[doc = "Bit 1 - UART_0"]
    #[inline(always)]
    pub fn uart_0(&mut self) -> Uart0W<'_, ClkApbPClearSpec> {
        Uart0W::new(self, 1)
    }
    #[doc = "Bit 2 - UART_1"]
    #[inline(always)]
    pub fn uart_1(&mut self) -> Uart1W<'_, ClkApbPClearSpec> {
        Uart1W::new(self, 2)
    }
    #[doc = "Bit 3 - Timer16_0"]
    #[inline(always)]
    pub fn timer16_0(&mut self) -> Timer16_0W<'_, ClkApbPClearSpec> {
        Timer16_0W::new(self, 3)
    }
    #[doc = "Bit 4 - Timer16_1"]
    #[inline(always)]
    pub fn timer16_1(&mut self) -> Timer16_1W<'_, ClkApbPClearSpec> {
        Timer16_1W::new(self, 4)
    }
    #[doc = "Bit 5 - Timer16_2"]
    #[inline(always)]
    pub fn timer16_2(&mut self) -> Timer16_2W<'_, ClkApbPClearSpec> {
        Timer16_2W::new(self, 5)
    }
    #[doc = "Bit 6 - Timer32_1"]
    #[inline(always)]
    pub fn timer32_1(&mut self) -> Timer32_1W<'_, ClkApbPClearSpec> {
        Timer32_1W::new(self, 6)
    }
    #[doc = "Bit 7 - Timer32_2"]
    #[inline(always)]
    pub fn timer32_2(&mut self) -> Timer32_2W<'_, ClkApbPClearSpec> {
        Timer32_2W::new(self, 7)
    }
    #[doc = "Bit 8 - SPI_0"]
    #[inline(always)]
    pub fn spi_0(&mut self) -> Spi0W<'_, ClkApbPClearSpec> {
        Spi0W::new(self, 8)
    }
    #[doc = "Bit 9 - SPI_1"]
    #[inline(always)]
    pub fn spi_1(&mut self) -> Spi1W<'_, ClkApbPClearSpec> {
        Spi1W::new(self, 9)
    }
    #[doc = "Bit 10 - I2C_0"]
    #[inline(always)]
    pub fn i2c_0(&mut self) -> I2c0W<'_, ClkApbPClearSpec> {
        I2c0W::new(self, 10)
    }
    #[doc = "Bit 11 - I2C_1"]
    #[inline(always)]
    pub fn i2c_1(&mut self) -> I2c1W<'_, ClkApbPClearSpec> {
        I2c1W::new(self, 11)
    }
    #[doc = "Bit 12 - GPIO_0"]
    #[inline(always)]
    pub fn gpio_0(&mut self) -> Gpio0W<'_, ClkApbPClearSpec> {
        Gpio0W::new(self, 12)
    }
    #[doc = "Bit 13 - GPIO_1"]
    #[inline(always)]
    pub fn gpio_1(&mut self) -> Gpio1W<'_, ClkApbPClearSpec> {
        Gpio1W::new(self, 13)
    }
    #[doc = "Bit 14 - GPIO_2"]
    #[inline(always)]
    pub fn gpio_2(&mut self) -> Gpio2W<'_, ClkApbPClearSpec> {
        Gpio2W::new(self, 14)
    }
    #[doc = "Bit 15 - Регистры аналоговых блоков"]
    #[inline(always)]
    pub fn analog_regs(&mut self) -> AnalogRegsW<'_, ClkApbPClearSpec> {
        AnalogRegsW::new(self, 15)
    }
    #[doc = "Bit 16 - Схема формирования прерываний GPIO"]
    #[inline(always)]
    pub fn gpio_irq(&mut self) -> GpioIrqW<'_, ClkApbPClearSpec> {
