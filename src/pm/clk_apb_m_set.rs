...
impl W {
    #[doc = "Bit 0 - Блок управления питанием (PM - Power Monitor)"]
    #[inline(always)]
    pub fn pm(&mut self) -> PmW<'_, ClkApbMSetSpec> {
        PmW::new(self, 0)
    }
    #[doc = "Bit 1 - Контроллер прерываний"]
    #[inline(always)]
    pub fn epic(&mut self) -> EpicW<'_, ClkApbMSetSpec> {
        EpicW::new(self, 1)
    }
    #[doc = "Bit 2 - Таймер32_0"]
    #[inline(always)]
    pub fn timer32_0(&mut self) -> Timer32_0W<'_, ClkApbMSetSpec> {
        Timer32_0W::new(self, 2)
    }
    #[doc = "Bit 3 - Контроллер выводов"]
    #[inline(always)]
    pub fn pad_config(&mut self) -> PadConfigW<'_, ClkApbMSetSpec> {
        PadConfigW::new(self, 3)
    }
    #[doc = "Bit 4 - Сторожевой таймер шины"]
    #[inline(always)]
    pub fn wdt_bus(&mut self) -> WdtBusW<'_, ClkApbMSetSpec> {
        WdtBusW::new(self, 4)
    }
    #[doc = "Bit 5 - OTP"]
    #[inline(always)]
    pub fn otp(&mut self) -> OtpW<'_, ClkApbMSetSpec> {
        OtpW::new(self, 5)
    }
    #[doc = "Bit 6 - Монитор питания системного домена"]
    #[inline(always)]
    pub fn pvd(&mut self) -> PvdW<'_, ClkApbMSetSpec> {
        PvdW::new(self, 6)
    }
    #[doc = "Bit 7 - Блок WakeUp (WU) батарейного домена"]
    #[inline(always)]
    pub fn wu(&mut self) -> WuW<'_, ClkApbMSetSpec> {
        WuW::new(self, 7)
    }
    #[doc = "Bit 8 - RTC батарейного домена"]
    #[inline(always)]
    pub fn rtc(&mut self) -> RtcW<'_, ClkApbMSetSpec> {
        RtcW::new(self, 8)
    }
}
