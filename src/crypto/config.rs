...
impl W {
    #[doc = "Bit 0 - Задаёт режим хода вычислительного ядра"]
    #[inline(always)]
    pub fn decode(&mut self) -> DecodeW<'_, ConfigSpec> {
        DecodeW::new(self, 0)
    }
    #[doc = "Bits 1:2 - Регистр выбора алгоритма шифрования"]
    #[inline(always)]
    pub fn core_sel(&mut self) -> CoreSelW<'_, ConfigSpec> {
        CoreSelW::new(self, 1)
    }
    #[doc = "Bits 3:4 - Регистр выбора режима шифрования"]
    #[inline(always)]
    ...
    #[doc = "Bits 5:6 - Регистр выбора режима перестановки слова"]
    #[inline(always)]
    pub fn swap_mode(&mut self) -> SwapModeW<'_, ConfigSpec> {
        SwapModeW::new(self, 5)
    }
    #[doc = "Bit 7 - Выбор порядка загрузки/выгрузки"]
    #[inline(always)]
    pub fn order_mode(&mut self) -> OrderModeW<'_, ConfigSpec> {
        OrderModeW::new(self, 7)
    }
    #[doc = "Bit 8 - Сброс счётчиков загружаемых/выгружаемых данных"]
    #[inline(always)]
    pub fn c_reset(&mut self) -> CResetW<'_, ConfigSpec> {
        CResetW::new(self, 8)
    }
}
