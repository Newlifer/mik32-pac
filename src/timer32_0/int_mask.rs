...
impl W {
    #[doc = "Bit 0 - Маска прерывания по переполнению счетчика"]
    #[inline(always)]
    pub fn ovf_int(&mut self) -> OvfIntW<'_, IntMaskSpec> {
        OvfIntW::new(self, 0)
    }
    #[doc = "Bit 1 - Маска прерывания опустошения счетчика"]
    #[inline(always)]
    pub fn udf_int(&mut self) -> UdfIntW<'_, IntMaskSpec> {
        UdfIntW::new(self, 1)
    }
    #[doc = "Bit 2 - Маска прерывания захвата 1 канала таймера"]
    #[inline(always)]
    pub fn ic_int_ch1(&mut self) -> IcIntCh1W<'_, IntMaskSpec> {
        IcIntCh1W::new(self, 2)
    }
    #[doc = "Bit 3 - Маска прерывания захвата 2 канала таймера"]
    #[inline(always)]
    pub fn ic_int_ch2(&mut self) -> IcIntCh2W<'_, IntMaskSpec> {
        IcIntCh2W::new(self, 3)
    }
    #[doc = "Bit 4 - Маска прерывания захвата 3 канала таймера"]
    #[inline(always)]
    pub fn ic_int_ch3(&mut self) -> IcIntCh3W<'_, IntMaskSpec> {
        IcIntCh3W::new(self, 4)
    }
    #[doc = "Bit 5 - Маска прерывания захвата 4 канала таймера"]
    #[inline(always)]
    pub fn ic_int_ch4(&mut self) -> IcIntCh4W<'_, IntMaskSpec> {
        IcIntCh4W::new(self, 5)
    }
    #[doc = "Bit 6 - Маска прерывания совпадения 1 канала таймера"]
    #[inline(always)]
    pub fn oc_int_ch1(&mut self) -> OcIntCh1W<'_, IntMaskSpec> {
        OcIntCh1W::new(self, 6)
    }
    #[doc = "Bit 7 - Маска прерывания совпадения 2 канала таймера"]
    #[inline(always)]
    pub fn oc_int_ch2(&mut self) -> OcIntCh2W<'_, IntMaskSpec> {
        OcIntCh2W::new(self, 7)
    }
    #[doc = "Bit 8 - Маска прерывания совпадения 3 канала таймера"]
    #[inline(always)]
    pub fn oc_int_ch3(&mut self) -> OcIntCh3W<'_, IntMaskSpec> {
        OcIntCh3W::new(self, 8)
    }
    #[doc = "Bit 9 - Маска прерывания совпадения 4 канала таймера"]
    #[inline(always)]
    pub fn oc_int_ch4(&mut self) -> OcIntCh4W<'_, IntMaskSpec> {
